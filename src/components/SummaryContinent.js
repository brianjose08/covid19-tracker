        ...
        return (
            <div className="col-sm-6 col-lg-4 col-12">
                <div className="summary-detail">
                    ...
                    <div className="summary-extra-information">
                        <p>
                            {continent.active.toString().replace(/\B(?=(\d{3})+(?!\d))/g, " ") + " active"} <span className="positive-change">{(continent.active - continent_yesterday.active).toString().replace(/\B(?=(\d{3})+(?!\d))/g, " ")}</span>
                        </p>
                    </div>
                </div>
            </div>
